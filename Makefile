...
vendor_saved_apps := Bluetooth NfcNci KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     ...
                     ProxyHandler TimeService Stk Shell DefaultContainerService
...
#-----------------------------------------------------------------------------
vendor_modify_apps := DeviceSettings_Flyme DeviceSettingsProvider
...
#-----------------------------------------------------------------------------
vendor_modify_jars := android.policy framework services telephony-common wifi-service core-libart
...
override_property += \
    ...
    ro.product.model_romer=klte_luo2888
